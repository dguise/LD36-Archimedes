...
namespace Assets.Scripts
{
    public class LevelManager : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            switch(level)
            {
                case 1: lista = new List<float>() { 10, 2, 2, 3, 1, 1, 1, 1, 1, 1, 1 };
                        boat_pos = new List<int>() { 1, 1, 2, 2, 3, 3, 1, 2, 3, 3, 2 }; break;
                case 2: lista = new List<float>() { 10, 2, 2, 3, 1, 1, 1, 1, 1, 1, 1 };
                        boat_pos = new List<int>() { 1, 1, 2, 2, 3, 3, 1, 2, 3, 3, 2 }; break;
                case 3: lista = new List<float>() { 10, 2, 2, 3, 1, 1, 1, 1, 1, 1, 1 };
                        boat_pos = new List<int>() { 1, 1, 2, 2, 3, 3, 1, 2, 3, 3, 2 }; break;
                case 4: lista = new List<float>() { 10, 2, 2, 3, 1, 1, 1, 1, 1, 1, 1 };
                        boat_pos = new List<int>() { 1, 1, 2, 2, 3, 3, 1, 2, 3, 3, 2 }; break;
                case 5: lista = new List<float>() { 10, 2, 2, 3, 1, 1, 1, 1, 1, 1, 1 };
                        boat_pos = new List<int>() { 1, 1, 2, 2, 3, 3, 1, 2, 3, 3, 2 }; break;
            }
